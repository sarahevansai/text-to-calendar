 ...
 */
async function parseEventFromSMS(message, timezone = 'America/Los_Angeles') {
  const now = new Date();
...
Examples:
- "add dentist wednesday 3:30pm" → title: "Dentist Appointment", calc next Wednesday, 15:30-16:30
- "Grammy coming Saturday 10am" → title: "Grammy Visit", calc next Saturday, 10:00-11:00
- "soccer thursday 4pm 2 hours" → title: "Soccer Practice", 16:00-18:00
- "dinner with mom friday 7pm" → title: "Dinner with Mom", 19:00-20:00
