...
If this IS a calendar event:
{
  ...
  "startTime": "HH:MM",
  "endTime": "HH:MM",
  "location": "Physical location or venue extracted from the message, or empty string if not mentioned",
  "description": "Extra notes, reminders, or instructions from the message (e.g. 'Bring insurance card', 'Pack lunch'), or empty string",
...
Location rules:
- Extract the physical place/venue if mentioned. Capitalize properly.
- "at main street clinic" → location: "Main Street Clinic"
- "at the dentist office" → location: "Dentist Office"
- "123 oak ave" → location: "123 Oak Ave"
- "home" or "at home" → location: "Home"
- "home field" → location: "Home Field"
- "conference room B" → location: "Conference Room B"
- "soccer, home field" → location: "Home Field" (after the comma can be a location)
- If no location is mentioned → location: "" (empty string, NOT null)
- Do NOT include location in the title or description

Notes/description rules:
- Extract any extra instructions, reminders, or context as the description.
- "bring insurance card" → description: "Bring insurance card"
- "remember: milk and eggs" → description: "Milk and eggs"
- "pack lunch" → description: "Pack lunch"
- "remind about allergies" → description: "Remind about allergies"
- Notes often appear after a comma or colon following the event/location details
- If no notes are mentioned → description: "" (empty string)
- Do NOT duplicate location info in the description

Examples:
- "add dentist wednesday 3:30pm" → title: "Dentist Appointment", location: "", description: "", forPerson: null
- "Jake's dentist wednesday 3pm" → title: "Dentist Appointment", location: "", description: "", forPerson: "Jake"
- "Jake's dentist at main street clinic wednesday 3pm, bring insurance card" → title: "Dentist Appointment", location: "Main Street Clinic", description: "Bring insurance card", forPerson: "Jake"
- "Emma's soccer friday 4pm, home field" → title: "Soccer Practice", location: "Home Field", description: "", forPerson: "Emma"
- "add grocery shopping monday 2pm, remember: milk and eggs" → title: "Grocery Shopping", location: "", description: "Milk and eggs", forPerson: null
- "Dad's work meeting thursday 9am conference room B" → title: "Work Meeting", location: "Conference Room B", description: "", forPerson: "Dad"
- "dentist for Emma thursday 2pm" → title: "Dentist Appointment", location: "", description: "", forPerson: "Emma"
- "Grammy coming Saturday 10am" → title: "Grammy Visit", location: "", description: "", forPerson: null
- "soccer thursday 4pm 2 hours" → title: "Soccer Practice", 16:00-18:00, location: "", description: "", forPerson: null
- "dinner with mom friday 7pm" → title: "Dinner with Mom", 19:00-20:00, location: "", description: "", forPerson: null
